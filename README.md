...
This is a CodeLlama-34B-Python-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-codellama-34b-python-gptq/fork) repository to your own Github account.
